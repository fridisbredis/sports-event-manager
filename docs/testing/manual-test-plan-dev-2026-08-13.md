...
- Dev och prod är **separata Supabase-projekt** (dev: `lhflutwvwvzawzbcuwup`, prod: `rauvaxuypujbeintnnoe`, Stockholm). Migrationerna 0017, 0018, 0019 är körda mot **båda**, så schemat var i synk t.o.m. 0019.
